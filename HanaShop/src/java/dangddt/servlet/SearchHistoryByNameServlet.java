 ...
 * @author Tam Dang
 */
@WebServlet(name = "SearchHistoryByNameServlet", urlPatterns = {"/SearchHistoryByNameServlet"})
public class SearchHistoryByNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            bills = BillDAO.searchBillByName(keyword);
            ...
            Logger.getLogger(SearchHistoryByNameServlet.class.getName()).log(Level.SEVERE, null, ex);

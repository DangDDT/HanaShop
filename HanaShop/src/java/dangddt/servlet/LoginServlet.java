...
public class LoginServlet extends HttpServlet {
    ...
    private static final String LOGIN_SUCCESS = "LoadDataServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AccountDTO result = AccountDAO.checkLogin(username, password);
            if (result != null) {
                url = LOGIN_SUCCESS;
            ...
            log("LoginServlet_SQL");
        } catch (NamingException ex) {
            log("LoginServlet_Naming");
        } catch (ClassNotFoundException ex) {
            log("LoginServlet_ClassNotFound");
        }finally{
